                    ...
                    <div id="conteudo">
                        ...
                        <div id="consulta">
                            <form id="consulta" action="consultasAluno.jsp">
                                ...
                                <input type="button" value="carregar" onclick="carregar('resultado','Cadastro?','pesquisa=<%=  request.getParameter("pesquisa")%>')">
                                <br />
