        ...
        <div id="tudo">
            ...
            <div id="conteudo-geral">
                ...
                <div id="painel_conteudo">
                    ...
                    <div id="conteudo">
                        <form id="cadastrarAluno" name="cadastrarAluno" action="AlterarProfessor" method="GET">
                            ...
                            <fieldset id="aluno1" name="aluno1">
                                ...
                                <input id="titulo" name="titulo" type = "text" class="texto" maxlength="54" />

                                <br /><label>Data de Admissão</label>
                                <input id="dataadm" name="dataadm" type = "text" class="texto" maxlength="54" />
                            ...
                            <fieldset id="aluno2" name="aluno2">
                                ...
                                <input id="btSalvarAluno" class="button" type="submit" value="Atualizar Professor"/>
