            ...
            <div id="conteudo-geral">
                ...
                <div id="painel_conteudo">
                    ...
                    <div id="conteudo">
                        ...
                        <form id="cadastrarTurma" name="cadastrarTurma "action="AlterarTurma" method="GET">
                            <fieldset id="combo">
                            ...
                            <fieldset id="turma" class="coluna">
                                ...
                                <input id="codTurma" name="codTurma" type ="text" class="texto" maxlength="12" value="<%= request.getParameter("codTurma")%>" readonly="true"/>

                                <br /><label>Turno*</label>
                                <input id="turnoTurma" name="turnoTurma" type ="text" class="texto" maxlength="12" value="<%= request.getParameter("turnoTurma")%>"/>

                                <br /><label>Série*</label>
                                <input id="serieTurma" name="serieTurma" type ="text" class="texto" maxlength="12" value="<%= request.getParameter("serieTurma")%>"/>

                                <br /><label>Classe*</label>
                                <input id="sclasseTurma" name="classeTurma" type ="text" class="texto" maxlength="2" value="<%= request.getParameter("classeTurma")%>"/>

                                <br /><label>Ano Letivo*</label>
                                <input id="anoTurma" name="anoTurma" type ="text" class="texto" maxlength="4" value="<%= request.getParameter("anoTurma")%>"/>
                                ...
                                <input name="codAntigo" id="codAntigo" type="text" hidden maxlength="12" value="<%= codTurma%>" />

                                <br />
                                <br />
                                <br />
                                <input id="btSalvarTurma" class="button" type="submit" value="Atualizar Turma"/>
